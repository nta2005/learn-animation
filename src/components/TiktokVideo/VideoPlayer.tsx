...
import { WINDOW_WIDTH, WINDOW_HEIGHT, getMusicNoteAnimation } from 'utils';
...
const VideoItem: React.FC<Props> = ({ data, isActive }) => {
	...
	const musicNoteAnimation2 = getMusicNoteAnimation(musicNoteAnimatedValue1, true);
			...
			<View style={styles.bottomSection}>
				<View style={styles.bottomLeftSection}>
					...
					<View style={styles.musicNameContainer}>
						<Image source={images.tiktok.musicNote} style={styles.musicNameIcon} />
				...
				<View style={styles.bottomRightSection}>
					<Animated.Image
						source={images.tiktok.floatingMusicNote}
			...
			<View style={styles.verticalBar}>
				<View style={[styles.verticalBarItem, styles.avatarContainer]}>
					...
					<View style={styles.followButton}>
						<Image source={images.tiktok.plusButton} style={styles.followIcon} />
					</View>
				</View>

				<View style={styles.verticalBarItem}>
					<Image source={images.tiktok.heart} style={styles.verticalBarIcon} />
					<Text style={styles.verticalBarText}>{likes}</Text>
				</View>

				<View style={styles.verticalBarItem}>
					<Image source={images.tiktok.messageCircle} style={styles.verticalBarIcon} />
					<Text style={styles.verticalBarText}>{comments}</Text>
				</View>

				<View style={styles.verticalBarItem}>
					<Image source={images.tiktok.reply} style={styles.verticalBarIcon} />
