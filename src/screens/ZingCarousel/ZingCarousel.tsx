...
import { WINDOW_HEIGHT, WINDOW_WIDTH, genresData } from 'utils';
	...
	return (
		<View style={styles.container}>
			...
			<ScrollView
				...
				<Image source={images.zing.curve} style={styles.curve} />
				<FlatList
					...
					onMomentumScrollEnd={(e) => {
						const index = Math.round(e.nativeEvent.contentOffset.x / CAROUSEL_ITEM_SIZE) + 2;
