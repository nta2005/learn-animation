...
const TikTokMusicDisc: React.FC = () => {
	...
	return (
		<View style={[styles.container]}>
			<View>
				<Animated.Image
					source={images.tiktok.musicNote}
				...
				/>
				<Animated.Image source={images.tiktok.disc} style={[styles.musicDisc, discAnimation]} />
			</View>
		</View>
	);
};

export default TikTokMusicDisc;
