...
import { tarotData, WINDOW_WIDTH } from 'utils';
...
const Tarot = () => {
	...
	return (
		<View style={styles.container}>
			<StatusBar hidden />
			<View>
				<Image source={images.tarot.readerNoEyes} style={styles.readerImage} />
				<Image source={images.tarot.eyes} style={styles.readerEyesImage} />
			</View>
				...
				{cards.map((item, index) => {
					...
					return (
						<View style={[styles.card, animationStyle]} key={index}>
							<Image source={images.tarot.eye} style={styles.eye} />
						</View>
					);
				})}
				<Image source={images.tarot.ellipse} style={styles.ellipse} />
			</View>
		</View>
	);
};
