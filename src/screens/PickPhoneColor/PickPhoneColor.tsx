...
import { WINDOW_WIDTH, iphoneImages, iphoneColors as colors } from 'utils';

const PickPhoneColor: React.FC = () => {
			...
			<View style={styles.grid}>
				{colors.map(({ code, name }, index) => (
					<TouchableOpacity
						...
						<Text style={[index === pickedColorIndex && styles.hightlighted]}>{name}</Text>
					</TouchableOpacity>
				))}
			</View>
		</View>
